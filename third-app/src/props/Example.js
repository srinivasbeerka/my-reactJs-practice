...
const Example=()=>{
  ...
  return(
    <div>
        {
          data.map((eachObj)=>{
            const {id,title,url,thumbnailUrl}=eachObj;  //destructuring

            return <Profile key={id} id={id} title={title} url={url} thumbnailUrl={thumbnailUrl}/>
...
const Profile=(props)=>{
   ...
   return(
       ...
       <div>
            ...
            <a href={url} type="button" class="btn btn-primary">Button</a>
